...
[training_labels, training_histograms, training_paths] = get_labeled_histograms_from_set(categories, 'train', training_image_count_per_category, training_image_count_per_category, C);
